...
export const longformTranslations = {
	zh: {
		...
		'longform.variants.03.title': 'BLE与USB的实验含义',
		'longform.variants.03.body': '无线和有线模式的差别不只是吞吐量。BLE允许自然活动并降低线缆牵引伪迹，但必须面对调度间隔、重传和移动端功耗；USB提供持续供电与稳定带宽，却可能改变手腕运动范围。两种模式保持相同的逻辑样本和质量字段，使传输条件本身能够成为受控变量。',
		...
		'longform.motion.01.title': 'IMU提供语境而非真值',
